...
const AddProject = () => {
  ...
  function formValidation() {
    if (form.Author !== "" && form.title !== "" && form.description !== "" && form.image !== "") {
        addMovie();
        setTimeout(()=>{
          navigate('/');
        },3000);
            ...
            <option value="Others">others</option>
              ...
              <div class="p-2 w-full">
                <div class="relative">
                 ...
                 <button className="bg-blue-300 px-4 py-1 text-black rounded-lg mt-2 " onClick={handleClick}>Upload</button>
                  {/* <input
                    id="message"
                    name="message"
                    value={form.image}
